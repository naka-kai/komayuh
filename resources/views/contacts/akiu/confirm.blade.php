...
<div class="bg-orange-100 bg-opacity-50 mx-[calc(50%_-_50vw)]">
    <div class="container max-w-5xl px-8 py-20">
        <h1 class="font-bold text-2xl mb-10 text-center">秋保イベントの応募内容確認</h1>
        <div class="text-lg leading-8">
            <form action="{{ route('akiu.thanks') }}" method="POST" enctype="multipart/form-data" id="akiu_form">
                @csrf
                ...
                <div class="flex flex-col justify-center items-center my-10 md:flex-row-reverse">
                    <button type="submit" name="action" value="submit" id="akiu_submit" class="border border-black bg-orange-200 hover:bg-opacity-80 py-2 px-8 rounded font-bold text-lg md:ml-8">送信</button>
